...
import { TodoRepository } from '@swiftav/infrastructure-storage';
import type { ITodoRepository } from '@swiftav/infrastructure-storage';
import { TodoController } from '@swiftav/interface-adapters';
